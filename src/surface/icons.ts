/**
 * 线性图标原语（DS·E2）——inline SVG path 注册表 + icon() 渲染器（stroke 跟随 currentColor）。
 * 从 dev/console.ts 抽出成共享原语：导航/会议/工具栏可统一引用。
 * （toolbar.ts 现为另一套工具图标设计、mobile.html 是独立 HTML；它们迁来统一 = 后续，避免改现有视觉。）
 */
